...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        obstacle1_center = self.o + np.array([pixels * 0, pixels * 2])
        ...
        # Obstacle 2
        # Defining the center of obstacle 1
        obstacle2_center = self.o + np.array([pixels, pixels * 2])
        ...
        # Saving the coordinates of obstacle 1 according to the size of agent
        # In order to fit the coordinates of the agent
        self.coords_obstacle2 = [self.canvas_widget.coords(self.obstacle1)[0] + 3,
                                 self.canvas_widget.coords(self.obstacle1)[1] + 3,
                                 self.canvas_widget.coords(self.obstacle1)[2] - 3,
                                 self.canvas_widget.coords(self.obstacle1)[3] - 3]
        ...
        obstacle3_center = self.o + np.array([pixels * 2, pixels * 2])
        # Building the obstacle 2
        ...
        obstacle4_center = self.o + np.array([pixels * 3, pixels * 2])
        ...
        obstacle5_center = self.o + np.array([pixels * 3, pixels * 3])
        ...
        self.obstacle5 = self.canvas_widget.create_rectangle(
            ...
            outline='grey', fill='#00BFFF')
        # Saving the coordinates of obstacle 5 according to the size of agent
        # In order to fit the coordinates of the agent
        self.coords_obstacle5 = [self.canvas_widget.coords(self.obstacle4)[0] + 3,
        ...
        obstacle6_center = self.o + np.array([pixels * 3, pixels * 4])
        ...
        obstacle7_center = self.o + np.array([pixels * 3, pixels * 5])
        ...
        obstacle8_center = self.o + np.array([pixels * 3, pixels * 6])
        ...
        obstacle9_center = self.o + np.array([pixels * 3, pixels * 7])
        # Building the obstacle 4
        ...
        obstacle10_center = self.o + np.array([pixels * 3, pixels * 8])
        ...
        obstacle11_center = self.o + np.array([pixels * 3, pixels * 9])
        ...
        # Obstacle 12
        # Defining the center of obstacle 5
        obstacle12_center = self.o + np.array([pixels * 3, pixels * 10])
        ...
        obstacle13_center = self.o + np.array([pixels * 3, pixels * 11])
        ...
        obstacle14_center = self.o + np.array([pixels * 3, pixels * 12])
        ...
        obstacle15_center = self.o + np.array([pixels * 4, pixels * 12])
        # Building the obstacle 8
        ...
        obstacle16_center = self.o + np.array([pixels * 6, pixels * 12])
        ...
        obstacle17_center = self.o + np.array([pixels * 5, pixels * 12])
        # Building the obstacle 10
        ...
        obstacle22_center = self.o + np.array([pixels * 11, pixels * 15])
        ...
        obstacle23_center = self.o + np.array([pixels * 12, pixels * 15])
        ...
        obstacle24_center = self.o + np.array([pixels * 13, pixels * 15])
        ...
        # Obstacle 20
        # Defining the center of obstacle 20
        obstacle20_center = self.o + np.array([pixels * 10, pixels * 15])
        ...
        obstacle21_center = self.o + np.array([pixels * 9, pixels * 15])
        ...
        # Obstacle 19
        # Defining the center of obstacle 19
        obstacle19_center = self.o + np.array([pixels * 8, pixels * 14])
        # Building the obstacle 19
        ...
        obstacle18_center = self.o + np.array([pixels * 7, pixels * 13])
        ...
        obstacle25_center = self.o + np.array([pixels * 13, pixels * 16])
        ...
        obstacle26_center = self.o + np.array([pixels * 13, pixels * 17])
        ...
        obstacle39_center = self.o + np.array([pixels * 21, pixels * 22])
        ...
        obstacle38_center = self.o + np.array([pixels * 20, pixels * 22])
        ...
        obstacle37_center = self.o + np.array([pixels * 19, pixels * 22])
        ...
        obstacle36_center = self.o + np.array([pixels * 18, pixels * 22])
        ...
        obstacle35_center = self.o + np.array([pixels * 18, pixels * 21])
        ...
        obstacle34_center = self.o + np.array([pixels * 18, pixels * 20])
        ...
        obstacle33_center = self.o + np.array([pixels * 18, pixels * 19])
        ...
        obstacle32_center = self.o + np.array([pixels * 18, pixels * 18])
        ...
        obstacle31_center = self.o + np.array([pixels * 17, pixels * 18])
        ...
        obstacle30_center = self.o + np.array([pixels * 16, pixels * 18])
        # Building the obstacle 31
        ...
        obstacle29_center = self.o + np.array([pixels * 15, pixels * 18])
        ...
        obstacle28_center = self.o + np.array([pixels * 14, pixels * 18])
        ...
        obstacle27_center = self.o + np.array([pixels * 13, pixels * 18])
        ...
        obstacle46_center = self.o + np.array([pixels * 11, pixels * 6])
        ...
        obstacle47_center = self.o + np.array([pixels * 12, pixels * 6])
        ...
        # Obstacle 48
        # Defining the center of obstacle 34
        obstacle48_center = self.o + np.array([pixels * 13, pixels * 6])
        # Building the obstacle 34
        ...
        obstacle49_center = self.o + np.array([pixels * 14, pixels * 6])
        ...
        obstacle50_center = self.o + np.array([pixels * 14, pixels * 7])
        ...
        obstacle45_center = self.o + np.array([pixels * 11, pixels * 5])
        ...
        # In order to fit the coordinates of the agent
        self.coords_obstacle45 = [self.canvas_widget.coords(self.obstacle37)[0] + 3,
        ...
        obstacle40_center = self.o + np.array([pixels * 11, pixels])
        ...
        obstacle41_center = self.o + np.array([pixels * 11, pixels * 0])
        ...
        obstacle42_center = self.o + np.array([pixels * 11, pixels * 2])
        ...
        # In order to fit the coordinates of the agent
        self.coords_obstacle42 = [self.canvas_widget.coords(self.obstacle39)[0] + 3,
        ...
        obstacle43_center = self.o + np.array([pixels * 11, pixels * 3])
        ...
        obstacle44_center = self.o + np.array([pixels * 11, pixels * 4])
        ...
        obstacle54_center = self.o + np.array([pixels * 17, pixels * 10])
        # Building the obstacle 44
        ...
        obstacle55_center = self.o + np.array([pixels * 18, pixels * 10])
        ...
        # Obstacle 56
        # Defining the center of obstacle 46
        obstacle56_center = self.o + np.array([pixels * 19, pixels * 10])
        ...
        obstacle53_center = self.o + np.array([pixels * 16, pixels * 10])
        ...
        obstacle52_center = self.o + np.array([pixels * 16, pixels * 9])
        # Building the obstacle v
        ...
        obstacle51_center = self.o + np.array([pixels * 15, pixels * 8])
        ...
        self.obstacle51 = self.canvas_widget.create_rectangle(
            ...
            outline='grey', fill='#00BFFF')
        # Saving the coordinates of obstacle 51according to the size of agent
        # In order to fit the coordinates of the agent
